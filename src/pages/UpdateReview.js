...
// };
    ...
    return (<div className='flex justify-center items-center md:h-screen bg-gray-100'>
        <div className='grid md:grid-cols-2 md:px-6'>
            <div>
                <img src={updatePhoto} alt="registerPhoto" />
            </div>
            <div className='p-5'>
                <form className='space-y-4 border border-gray-300 md:w-2/3 mx-auto p-5 rounded'>
